        ...
        <div>
            ...
            <Container>
                <div className="flex-row-center" id="main-content">
                    <h1 className="gilroy" id="content-tittle" style={{ color: colors.SS2 }}>
                            ...
                            {hotellist.map((val) => {
                                return (
                                    <div className="col-md-6 col-12 mt-4">
                                        <HotelCard hotelname={val.hotelname} mobile={val.mobile} address={val.address} ratings={val.ratings} type={val.type} />
                                    </div>
                                );
                            })}
                        </div>
