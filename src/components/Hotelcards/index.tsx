  ...
  return (
    <Card>
        ...
        <Card.Body className='flex-column-center gap3'>
            <Card.Title className='gilroy flex-row-center gap10' style={{fontSize:'x-large'}}><FontAwesomeIcon icon={faUtensils} style={{color:colors.B4}} /> {props.hotelname}</Card.Title>
            <Card.Text className='gilroy flex-row-center gap10' ><FontAwesomeIcon icon={faCircle} style={props.type=='Vegeterian'?{color:colors.SS5}:{color:colors.ES8}} id={props.type}/> {props.type}</Card.Text>
